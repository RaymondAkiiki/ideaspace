...
// Separated into its own component so useSearchParams can be
// wrapped in Suspense — required by Next.js 14 for static builds
function LoginForm() {
      ...
      <div className="w-full max-w-sm">
        ...
        <Suspense fallback={
          <div className="bg-surface border border-border rounded-xl p-8 text-center">
            <span className="font-mono text-xs text-ink-3 uppercase tracking-widest animate-pulse">
              Loading…
            </span>
          </div>
        }>
